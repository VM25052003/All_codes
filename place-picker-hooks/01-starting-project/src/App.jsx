...
export default function App(){
    ...
    const { fetchedData: userPlace, isFetching, setFetchedData: setUserPlace, error } = useFetch(fetchUserPlaces, [])

    async function addPlaceHandler(currPlace){
        //This setUserPlace, is now managed in custom hook. So, extract that state used for fetching data, to now fetch Places here
