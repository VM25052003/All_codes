...
export default function FindEventsSection(){
    ...
    const { data, isLoading, isError, error } = useQuery({
        ...
        queryKey: ['events', { search: searching }],
        ...
        queryFn: ({ signal }) => fetchEvents({ searching, signal }),
        ...
        enabled: searching !== undefined
    })

    //Submit handler
    function submitHandler(e){
        e.preventDefault()
        setSearching(searchTerm.current.value)
    }
        ...
        <section className="content-section" id="all-events-section">
            <header>
                ...
                <form id="search-form" onSubmit={submitHandler}>
                    <input type="search" ref={searchTerm} placeholder="Search Term"/>
