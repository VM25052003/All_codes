...
export default function NewEvent(){
    ...
    //Not updating till we switch to a diff. page or refresh, as it triggers React query to refetch data behind the scenes. But data changed as we added a new event, want react query to immediately refetch data
